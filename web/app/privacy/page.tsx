...
const PrivacyPage = () => {
    ...
    return (
        <Container>
            ...
            k&ouml;nnen zur Analyse Ihres Nutzerverhaltens verwendet werden.</p> <h4>Welche Rechte haben Sie
        ...
        </p> <p>Die Verwendung von Hetzner erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein
            berechtigtes Interesse an einer m&ouml;glichst zuverl&auml;ssigen Darstellung unserer Website. Sofern eine
            ...
            oder den Zugriff auf Informationen im Endger&auml;t des Nutzers (z.&nbsp;B. Device-Fingerprinting) im Sinne
            ...
            auf dieser Website ist:</p> <p>Mathis Burger<br/>
            Friedrich-Ebert-Stra&szlig;e 37<br/>
            85055 Ingolstadt</p>

            <p>Telefon: &#91;Telefonnummer der verantwortlichen Stelle&#93;<br/>
                E-Mail: kontakt@mathis-burger.de</p>
