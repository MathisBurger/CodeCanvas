...
const AssignmentCreateOrUpdateCodeTestModal = ({onClose, groupId, assignmentId, refetch}: AssignmentCreateOrUpdateCodeTestModalProps) => {
    ...
    const submit = form.onSubmit(async (values) => {
        try {
            await api.createCodeTests(groupId, assignmentId, fileStructure, files, {...values} as RunnerConfig);
            refetch();
            onClose();
        } catch (e: any) {
            notifications.show({
