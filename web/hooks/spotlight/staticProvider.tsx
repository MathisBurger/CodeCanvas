...
export const useStaticRoutesActions = (): (SpotlightActionGroupData | SpotlightActionData)[] => {
...
export const useStaticGeneralActions = (): (SpotlightActionGroupData | SpotlightActionData)[] => {
